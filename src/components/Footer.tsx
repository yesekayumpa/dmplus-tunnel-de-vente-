          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-2">
              <p className="flex items-center gap-2 justify-center md:justify-start">
                ...
                <a href="mailto:academy@dmplus-group.com" className="hover:text-red-600 transition-colors">academy@dmplus-group.com</a>
              </p>
              <p className="flex items-center gap-2 justify-center md:justify-start">
                <svg className="w-4 h-4 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>+221 33 829 58 79</span>
              </p>
              <p className="flex items-center gap-2 justify-center md:justify-start">
                ...
                <a href="https://wa.me/221766638219" target="_blank" rel="noopener noreferrer" className="hover:text-red-600 transition-colors">+221 76 663 82 19</a>
              </p>
            </div>
          </div>
